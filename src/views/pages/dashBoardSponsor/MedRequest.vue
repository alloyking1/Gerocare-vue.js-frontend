<template>
  <div>
    ...
    <div class="view">
      <vs-popup classContent="popup-example" title="Medical Request" :active.sync="popupActive2">
            ...
            <vs-tab label="">
                <div class="vx-col w-full lg:w-3/3 sm:w-3/3 mb-base">
                    <vx-card class="p-2">
                        ...
                        <div class="flex justify-between flex-wrap">
                          <vs-button class="w-full mt-6 cutomBtn" style="background: #E65252 !important; border-radius:55px;" @click="">Delete</vs-button>
  ...
  methods:{
    ...
    async more(id){
      try{
        ...
        this.$vs.notify({title:'Error',text:'Could not load prescription, make sure you are still logged in',color:'danger',position:'top-right'});
      }
       
    },

    truncate (text, length, suffix=null) {
