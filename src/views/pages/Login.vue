...
<template>
  <div class="h-screen flex w-full bg-img2 vx-row no-gutter items-center justify-center" id="page-login">
                ...
                <div>
                  <form onsubmit="return false">
                    <vs-input
                        ...
                        v-model="user.email"
                    class="w-full"/>
                    <span class="text-danger text-sm">{{ error.email }}</span>
                    ...
                    <vs-input
                        ...
                        class="w-full mt-6" />
                    <span class="text-danger text-sm">{{ error.password }}</span>
